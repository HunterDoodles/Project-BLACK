...
public class CarControllerRedux : MonoBehaviour
{
    ...
    public float decay = 0.90f; //This value is a artificial drag value that does not interfere with the gravity
    ...
    void FixedUpdate() //Fixed update is called everytime physics is so this should be used for anything involving the physics
    {
        ...
        _rb.velocity=new Vector3(_rb.velocity.x* decay,_rb.velocity.y,_rb.velocity.z * decay);//Drag in the x,z axis.
